package com.eight.model.plotting.unit;
...
进黑名单,大于等于100分进白名单
    ...
    public void setCertificateSendDate(String certificateSendDate) {
        this.certificateSendDate = certificateSendDate == null ? null : certificateSendDate.trim();
    }
     ...
     */
    public void setFirstQualificationDate(String firstQualificationDate) {
        this.firstQualificationDate = firstQualificationDate == null ? null : firstQualificationDate.trim();
    }
